...
namespace data::math::number {
    ...
    template <endian::order o1, endian::order o2, size_t size1, size_t size2> 
    bool operator<=>(const bounded<false, o1, size1>&, const bounded<true, o2, size2>&);
    
    template <endian::order o1, endian::order o2, size_t size1, size_t size2> 
    bool operator<=>(const bounded<true, o1, size1>&, const bounded<false, o2, size2>&);
    
    template <endian::order o1, endian::order o2> 
    bool operator<=>(const bytes<false, o1>&, const bytes<true, o2>&);
    
    template <endian::order o1, endian::order o2> 
    bool operator<=>(const bytes<true, o1>&, const bytes<false, o2>&);
    
    template <endian::order o1, endian::order o2, size_t size> 
    bool operator<=>(const bounded<false, o1, size>&, const bytes<true, o2>&);
    
    template <endian::order o1, endian::order o2, size_t size> 
    bool operator<=>(const bounded<true, o1, size>&, const bytes<false, o2>&);
    
    template <endian::order o1, endian::order o2, size_t size> 
    bool operator<=>(const bytes<false, o1>&, const bounded<true, o2, size>&);
    
    template <endian::order o1, endian::order o2, size_t size> 
    bool operator<=>(const bytes<true, o1>&, const bounded<false, o2, size>&);
...
namespace data::math::number {
    ...
    class bounded : public bytestring<x> {
        using bit32 = meta::fundamental_arithmatic<is_signed, r>;
        using bit64 = twice<meta::unordered<bit32>>;
    ...
    public:
        bounded();
        bounded(bit64);
        explicit bounded(const bytestring<x>&);
