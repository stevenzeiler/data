...
namespace data {
    ...
    using nl = math::N_bytes<data::endian::little>;
    using nb = math::N_bytes<data::endian::big>;
    using zl = math::Z_bytes<data::endian::little>;
    using zb = math::Z_bytes<data::endian::big>;
/*
    // test whether these data structures satisfy the correct interfaces.
    TEST(FunctionalInterfaceTest, TestInt) {
        ...
        is_random_access_iterator<math::number::bit32_iterator<uint32, const byte>>();
        is_output_iterator<math::number::bit32_iterator<uint32, byte>, byte>();
        
        is_random_access_iterator<math::number::bit32_iterator<int32, const byte>>();
        is_output_iterator<math::number::bit32_iterator<int32, byte>, byte>();
        ...
        is_iterable<math::sint<endian::little, 5>, byte>();
        is_iterable<math::uint<endian::little, 5>, byte>();
        is_iterable<math::sint<endian::big, 5>, byte>();
        is_iterable<math::uint<endian::big, 5>, byte>();
